...
import com.example.adul.belajartdd.presenter.ArtikerlPresenter;
...
public class MainActivity extends AppCompatActivity implements ArtikelView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new ArtikerlPresenter(this);
    ...
    @Override
    public void showEmptyInputMessage(String s) {
        Snackbar.make(btn_simpan, s, Snackbar.LENGTH_SHORT).show();
    }

    @Override
    public void isSuccesValidateForm(String judul, String kategory, String kontent) {
